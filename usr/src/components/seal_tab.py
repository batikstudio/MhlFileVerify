...
import os
import subprocess
from PySide6.QtWidgets import (QFileDialog, QLineEdit, QMessageBox, QStatusBar, QComboBox)
...
class seal_tab_class:
    ...
    def launch_seal(self):
        ...
        if dir_to_seal == "":
            ...
            command_seal = f"./../bin/mhl seal -v -t \'{hash_type}\' -o \'{dir_to_seal}\' \'{dir_to_seal}\'"
